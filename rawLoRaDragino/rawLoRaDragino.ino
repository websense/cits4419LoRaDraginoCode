 ...
 * them to communicate.
 * 
 * Based on examples/raw from the MCCI LoRaWAN LMIC library Version 3.2.0
 * Modified for CITS4419 class using Dragain shield for Arduino
 * RCO Aug 2020
 *******************************************************************************/
...
// RCO Aug 2020 Pin mapping for Dragnio shield
// Note library raw.ino shield .dio differ
...
static void rx_func (osjob_t* job) {
  ...
  Serial.println();
  Serial.print("RX snr =");
  Serial.print(LMIC.snr/4); //LMIC.snr is 4*true snr
  Serial.print(" RX rssi = ");
  Serial.println(LMIC.rssi); //Datasheet RSSI adjustments done in radio.c
...
// RCO Aug 2020 removed all the country settings except Australia 
// see raw/raw.ino for the originals
  ...
  //LMIC.txpow = 30;
  LMIC.txpow = 16; //RCO Aug 2020 low power
